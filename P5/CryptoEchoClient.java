...
public class CryptoEchoClient {
 ...
 // Used for Computer Security, Spring 2019.    
    public static void main(String[] args) {
        ...
        try {
            Socket socket = new Socket(host, 1021);
            ...
            while (!done) {
                ...
                if (userStr.trim().equals("BYE")) {
                    ...
                    byte[] encryptedReply = (byte[])objectInput.readObject();
                    Cipher cipher2 = Cipher.getInstance("AES/CBC/PKCS5Padding");
                    cipher2.init(Cipher.DECRYPT_MODE, secretKey, new IvParameterSpec(iv));
                    String str = new String(cipher2.doFinal(encryptedReply));
